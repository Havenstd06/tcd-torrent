    ...
    if (value.yggPasskey) {
        ...
        for (let t = 0; t < tables.length; t++) {
            ...
            for (let r = 0; r < headerRow.length; r++) {
                ...
                if (isTorrentTable) {
                    const torrentId = headerRow[r].cells[2].children[0].getAttribute('target') ?? null;
                    ...
                    downloadIcon.setAttribute('src', chrome.runtime.getURL("icon-34.png"));
                    downloadIcon.setAttribute('style', "margin-right: 10px;width: 25px;height: 25px;display: inline-block;");
